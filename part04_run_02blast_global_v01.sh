...
#SBATCH --mem 192G ### or try with 8G if 4G is not enough
#SBATCH -c 8
#SBATCH -t 48:00:00
...
blastn -db nt -max_target_seqs 1000 -outfmt "6 std qlen qcovs sgi sseq ssciname staxid" -out "${OUTFLN1}" -qcov_hsp_perc 90 -perc_identity 80 -query "${INPFNM1}"
